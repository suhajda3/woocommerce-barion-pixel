 ...
 * Plugin URI: https://github.com/suhajda3/woocommerce-barion-pixel
    ...
    public function settings_page() {
        ...
        <div class="wrap">
            ...
            <ul style="list-style: disc; padding-left: 20px;">
                ...
                <li><?php _e('For plugin issues: Submit an issue on <a href="https://github.com/suhajda3/woocommerce-barion-pixel/issues" target="_blank">GitHub</a>', 'barion-pixel-wc'); ?></li>
            </ul>
        </div>
        <?php
    }
